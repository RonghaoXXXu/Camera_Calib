...
Mat T = (Mat_<double>(3, 1) << -61.34485, 2.89570, -4.76870);//T平移向量,对应Matlab所得T参数
...
{
    //对视差生成效果影响较大的主要参数是setSADWindowSize、setNumberDisparities和setUniquenessRatio，这三个参数要重点关注和调整。其他参数的影响不算很大。
...
int binocul()
{
    ...
    */
    ...
    读取图片
    */
    rgbImageL = imread("/home/feyker/Pictures/left0000.jpg", CV_LOAD_IMAGE_COLOR);
    cvtColor(rgbImageL, grayImageL, CV_BGR2GRAY);
    rgbImageR = imread("/home/feyker/Pictures/left0000.jpg", CV_LOAD_IMAGE_COLOR);
